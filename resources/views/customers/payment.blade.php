                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="font-weight-bold">{{ $Offer['upah'] }}</span></td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-1">
                                            <p class="card-text font-weight-bold mb-25">Native App Development
                                            </p>
