      ...
      <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::user()->name }}</span><span class="user-status"></span></div><span class="avatar"><img class="round" src="{{ url('vuexy/app-assets/images/avatars/admin-1.png') }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
              <a class="dropdown-item" href="/admin/change_psw"><i class="mr-50" data-feather="lock"></i>Ganti Password</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin/akun"><i data-feather="users"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Data User</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin/maids"><i data-feather="users"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Data Maid</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin/customers"><i data-feather="users"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Data Customer</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin/histories"><i data-feather="book"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Riwayat Kerja Sama</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/admin/payment"><i data-feather="dollar-sign"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Riwayat Transaksi/Pembayaran</span></a>
          </li>
