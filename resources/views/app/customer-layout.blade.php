...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
      ...
      <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::user()->name }}</span><span class="user-status"></span></div><span class="avatar"><img class="round" src="{{ url('vuexy/app-assets/images/avatars/customer-1.png') }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
              <a class="dropdown-item" href="/customer/change_psw"><i class="mr-50" data-feather="lock"></i>Ganti Password</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a class="d-flex align-items-center" href="/customers"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Home</span></a>
          </li>

          <li class=" nav-item"><a class="d-flex align-items-center" href="/customers/maids"><i data-feather="users"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Lihat Daftar Maids</span></a>
          </li>
          <li class=" nav-item"><a class="d-flex align-items-center" href="/customers/offer/sent"><i data-feather="book-open"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Lihat Tawaran Terkirim</span></a>
          </li>
          <li class=" nav-item"><a class="d-flex align-items-center" href="/customers/payment"><i data-feather="credit-card"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Lihat Tagihan Masuk</span></a>
          </li>
          <li class=" nav-item"><a class="d-flex align-items-center" href="/customers/histories"><i data-feather="octagon"></i>
            <span class="menu-title text-truncate" data-i18n="Dashboards">Lihat Riwayat Kerja Sama</span></a>
          </li>

          {{-- <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="folder"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Jobs</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="/maid/job/offer"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Lihat Tawaran Masuk</span></a>
              </li>
              <li><a class="d-flex align-items-center" href="/maid/job/history"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Riwayat Kerja</span></a>
              </li>
            </ul>
          </li> --}}
    ...
    <script src="{{ url('vuexy/app-assets/vendors/js/forms/repeater/jquery.repeater.min.js') }}"></script>
    ...
    <script src="{{ url('vuexy/app-assets/js/scripts/pages/app-invoice.min.js') }}"></script>
    <!-- END: Page JS-->
